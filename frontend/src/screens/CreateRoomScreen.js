...
export default function CreateRoomScreen({ navigation }) {
  ...
  const handleOpenVibeSelection = useCallback(() => {
    navigation.navigate('RoomVibeSelection', {
      selectedVibe,
      onSelect: handleChangeVibe,
    });
  }, [navigation, selectedVibe, handleChangeVibe]);
      ...
      <View style={styles.sectionGroup}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionLabelGroup}>
            <Text style={styles.sectionLabel && styles.sectionLabelPrivacy}>Vibe</Text>
            <TouchableOpacity style={styles.changeVibeButton} onPress={handleOpenVibeSelection}>
              <Text style={styles.changeVibeButtonText}>Promijeni</Text>
            </TouchableOpacity>
          </View>
          <VibeChip
            option={selectedVibeOption}
            active
            style={styles.selectedVibeCard}
            descriptionLines={2}
          />
        </View>
