...
// export const baseURL = (process.env.REACT_NATIVE_API_URL || 'http://192.168.0.28:8000').replace(/\/$/, '');
...
export const payVote = (userId, payload) => api.post(`/user/${userId}/votes/pay`, payload);
